...
export const definition = {
  name: 'testAWSLambdaLogSubscriber',
  description: 'A command for testing AWS consumer lambda',
  example: `whook testAWSLambdaLogSubscriber --name handleS3Lambda`,
  arguments: [
    {
      name: 'name',
      required: true,
...
async function initTestAWSLambdaLogSubscriberCommand({
  APP_ENV,
  PROJECT_DIR,
...
export default location(
  autoService(initTestAWSLambdaLogSubscriberCommand),
  import.meta.url,
);
