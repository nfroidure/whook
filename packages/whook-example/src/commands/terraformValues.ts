...
import { OpenAPI, pathItemToOperationMap } from 'ya-open-api-types';
      ...
      const configuration = {
        ...
        ...Object.keys(whookConfiguration || {}).reduce(
          (accConfigurations, key) => ({
            ...accConfigurations,
            [key]: (whookConfiguration as Record<string, string>)[
              key
            ].toString(),
          }),
          {},
      ...
      const openapi2 = yaml.dump(
        {
          ...
          paths: configurations.reduce(
            (accPaths, configuration) => {
