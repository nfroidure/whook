...
1. [A Whook baked API](#1-a-whook-baked-api)
   1. [The main file](#11-the-main-file)
      1. [runProcess](#111-runprocess)
         1. [Injected names](#1111-injected-names)
...
3. [API](#3-api)
   ...
   4. [Examples](#34-examples)
      ...
      5. [putEchoedStream](#345-putechoedstream)
...
[See in context](./src/index.ts#L38-L42)
...
[See in context](./src/routes/getDelay.ts#L76-L86)
...
[See in context](./src/routes/getDelay.ts#L91-L96)
...
[See in context](./src/routes/getDelay.ts#L32-L37)
...
[See in context](./src/routes/getDelay.ts#L101-L105)
...
[See in context](./src/routes/getDelay.ts#L52-L58)
...
[See in context](./src/routes/getDelay.ts#L124-L140)
...
[See in context](./src/routes/getDelay.ts#L165-L170)
...
[See in context](./src/routes/getDelay.ts#L189-L199)
...
[See in context](./src/services/API.ts#L72-L76)
...
[See in context](./src/services/API.ts#L80-L85)
...
[See in context](./src/routes/getDelay.ts#L23-L30)
...
[See in context](./src/routes/getParameters.ts#L92-L96)
...
#### 3.4.5. putEchoedStream

Simply outputs its input but as a stream.

[See in context](./src/routes/putEchoedStream.ts#L46-L49)
...
[See in context](./src/routes/getOpenAPI.ts#L14-L28)
...
[See in context](./src/services/queryParserBuilder.ts#L8-L21)
