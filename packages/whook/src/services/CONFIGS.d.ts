...
export declare type CONFIGSService = {
  [name: string]: any;
};
export declare type CONFIGSConfig = {
  PROJECT_SRC?: string;
  NODE_ENV?: string;
};
export declare type CONFIGSDependencies = CONFIGSConfig & {
  PROJECT_SRC: string;
  NODE_ENV: string;
  log?: LogService;
  require?: typeof _require;
};
export declare type WhookConfig = {
  name: string;
  description?: string;
  baseURL?: string;
};
