...
- 4 OAuth2 routes definitions implementing the OAuth2 standard endpoints
  (`getOAuth2Authorize`, `postOAuth2Token`, `postOAuth2Revoke`, `postOAuth2DeviceAuthorization`)
